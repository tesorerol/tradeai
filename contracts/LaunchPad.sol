...
contract LAUNCHPAD is Ownable,ReentrancyGuard {
    ...
    function Deposit(uint256 _amount) public nonReentrant ContractLock {
        ...
        uint256 earn = UserInfo.Amount.mul(PercentEarn).div(100);
        UserInfo.Earn=earn;
    ...
    function EarnReward() public nonReentrant ContractLock{
        Users memory UserInfo = balanceUser[msg.sender];
        ...
        UserInfo.finishTime = block.timestamp + 7 days;
        IERC20(TokenRecibe).transfer(msg.sender,amountTransfer);
    }
