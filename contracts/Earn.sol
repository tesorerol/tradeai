...
contract BeNFTEARN is Ownable,ReentrancyGuard {
...
// 0x3eb0c38dcfaf92889cb81b124114b6e3a195bb96
    constructor(address _walletPool, address _TokenRecibe, address _wallet1,address _wallet2, bool _whitelist) {
    ...
    function EarnClaim() public nonReentrant ContractLock{
        Users memory UserInfo = balanceUser[msg.sender];
