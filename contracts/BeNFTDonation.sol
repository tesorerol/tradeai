...
contract DonationBeNft is Ownable,ReentrancyGuard {
    using SafeMath for uint256;
    address public BenftWallet;
    ...
    constructor(address _walletPool, address _tokenRecibe) {
        BenftWallet = _walletPool;
        TokenRecibe=_tokenRecibe; 
    }

    function Donate(uint256 _amount) public nonReentrant ContractLock {
        ...
        IERC20(TokenRecibe).transferFrom(msg.sender,BenftWallet,_amount);
