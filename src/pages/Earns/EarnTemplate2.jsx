  ...
  return (
    <div className="earn-strategies">
      ...
      <div className='earn-strategies-ai'>
        ...
        <div className='earn-strategies-ai-details earn-strategies-ai-details-v2'>
                ...
                <div className="table-staked2">
                  ...
                  <div className="table-row row1">
                    ...
                    <p className="table-number">
                      ...
                      {formatMoney(
                        parseFloat(r.Earn)-parseFloat(r.Amount),
                        'USDT',
                      )}
                    </p>
                  </div>
