...
import EarnTemplatev2 from './EarnTemplatev2'
const EarnDinamic = () => {
  ...
  return (
    <>
      ...
      <>
        ...
        : 
        pool[0].AbiType==="v3" 
        ? <EarnTemplatev2 Abi={setTypeAbi(pool[0].AbiType)} AbiType={pool[0].AbiType} claim={pool[0].claim} desposit={pool[0].desposit} unique={pool[0].unique} type={pool[0].type} strategy={pool[0].strategy} EarnContract={pool[0].address} namePool={pool[0].namePool}  risk={pool[0].risk} token={pool[0].token}/>
