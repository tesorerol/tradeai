...
import { Allowance, Approve, formatMoney } from '../../Helpers'
import Swal from 'sweetalert2'
import Loader from '../../Components/Loading'
import Abi from '../../artifacts/contracts/BenftPassV2.sol/BENFTPASS2.json'
const Genv2 = () => {

  const EarnContract = "0xcBD4Cd389BCEc5Afa2EB80FE778cEC48149b07ff"
  const namePool = "Gen2 Presale 2"
  const token = "USDT"
