...
async function Approve(provider, address, token) {
  ...
  let result = await contract.approve(address, '99999999999999999999999999999999999999999999999999999999999')
    ...
    if (futureTime > currentTime) {
      return (
        <p className="text-button-remaining">
          ...
          <span id="seconds">{secondFloor > 0 ? secondFloor : 0}</span> seconds to Claim
        </p>
      )
    }
  }
